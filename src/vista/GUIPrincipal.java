...
public class GUIPrincipal extends JFrame implements WindowListener, KeyListener{
	...
	private void initCodes() {
		...
		generaModelo.setToolTipText(Lenguaje.text(Lenguaje.GENERATERELATIONAL));
		...
		generaCodigo.setToolTipText(Lenguaje.text(Lenguaje.GENERATEFISIC));
	...
	public boolean getScriptGeneradoCorrectamente(){
		return this.scriptGeneradoCorrectamente;
	}

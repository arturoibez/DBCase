...
public class TransferRelacion extends Transfer {
	...
	private boolean checkQuitarFlechas=false;
	private boolean relacionConCardinalidad=true;
	private boolean relacionConParticipacion=true;
	private boolean relacionConMinMax=true;
	private boolean relacionConCardinalidad1=true;
	...
	public TransferRelacion clonar() {
		...
		clon_tr.setCheckQuitarFlechas(this.getCheckQuitarFlechas());
		clon_tr.setRelacionConCardinalidad(this.getRelacionConCardinalidad());
	...
	public boolean getCheckQuitarFlechas() {
		return this.checkQuitarFlechas;
	}
	public void setCheckQuitarFlechas(boolean quitar) {
		this.checkQuitarFlechas=quitar;
	}
	...
	public void setRelacionConCardinalidad(boolean relacionConCardinalidad) {
		this.relacionConCardinalidad = relacionConCardinalidad;
	}
	public boolean getRelacionConParticipacion() {
		return relacionConParticipacion;
	}
	public void setRelacionConParticipacion(boolean relacionConParticipacion) {
		this.relacionConParticipacion = relacionConParticipacion;
	}
	public boolean getRelacionConMinMax() {
		return relacionConMinMax;
	}
	public void setRelacionConMinMax(boolean relacionConMinMax) {
		this.relacionConMinMax = relacionConMinMax;
	}
	public boolean getRelacionConCardinalidad1() {
		return relacionConCardinalidad1;
	}
